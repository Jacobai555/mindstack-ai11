...
const ToolsRoute = Route$7.update({
  id: "/tools",
  path: "/tools",
  getParentRoute: () => Route$8
});
const LearnRoute = Route$6.update({
  id: "/learn",
  path: "/learn",
  getParentRoute: () => Route$8
});
const CyberLabRoute = Route$5.update({
  id: "/cyber-lab",
  path: "/cyber-lab",
  getParentRoute: () => Route$8
});

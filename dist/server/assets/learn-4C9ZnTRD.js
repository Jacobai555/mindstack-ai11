...
import { BookOpen, ChevronDown, ChevronRight, Brain, Cpu, Network, Layers, Bot, Download } from "lucide-react";
const modules = [{
  id: "what-is-ai",
  ...
  id: "neural-networks",
  icon: /* @__PURE__ */ jsx(Network, { size: 20 }),
  ...
  id: "offline-ai",
  icon: /* @__PURE__ */ jsx(Download, { size: 20 }),
...
function DiagramBar({
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex flex-wrap items-center gap-1.5 mt-4 p-3 rounded-lg", style: {
    background: "rgba(0,0,0,0.2)",
    border: `1px solid ${color}15`
  }, children: items.map((item, i) => /* @__PURE__ */ jsx("span", { className: "text-xs px-2 py-1 rounded font-mono", style: {
...
function LearnPage() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen px-4 py-12", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center mb-14", children: [
      ...
      /* @__PURE__ */ jsx("h1", { className: "text-4xl font-bold mb-3 section-title gradient-text", children: "Learn AI" }),
      /* @__PURE__ */ jsx("p", { className: "text-sm mt-8 max-w-xl mx-auto", style: {
        color: "var(--text-muted)"
      }, children: "From fundamentals to cutting-edge techniques. Expandable modules with visual diagrams and practical examples." })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "glass-card p-4 mb-8 flex items-center gap-4", children: [
      /* @__PURE__ */ jsx("div", { className: "flex-1 bg-gray-800 rounded-full h-2", children: /* @__PURE__ */ jsx("div", { className: "h-2 rounded-full transition-all duration-500", style: {
        width: `${Object.keys(activeContent).length / modules.length * 100}%`,
        background: "linear-gradient(90deg, var(--neon-cyan), var(--neon-purple))",
        boxShadow: "0 0 8px var(--neon-cyan)"
      } }) }),
      /* @__PURE__ */ jsxs("span", { className: "text-xs whitespace-nowrap", style: {
        color: "var(--text-muted)"
      }, children: [
        Object.keys(activeContent).length,
        "/",
        modules.length,
        " explored"
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "space-y-4", children: modules.map((mod) => /* @__PURE__ */ jsxs("div", { className: "glass-card overflow-hidden", children: [
      ...
      }, className: "w-full p-5 flex items-center gap-4 text-left", children: [
        /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0", style: {
          background: `${mod.color}12`,
          border: `1px solid ${mod.color}25`,
          color: mod.color
        }, children: mod.icon }),
        /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsx("h3", { className: "font-semibold mb-0.5", style: {
            color: "var(--text-primary)"
          }, children: mod.title }),
          /* @__PURE__ */ jsx("p", { className: "text-xs truncate", style: {
            color: "var(--text-muted)"
          }, children: mod.summary })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 flex-shrink-0", children: [
          activeContent[mod.id] && /* @__PURE__ */ jsx("span", { className: "text-xs px-2 py-0.5 rounded-full", style: {
            color: "var(--neon-green)",
            background: "rgba(0,255,136,0.08)",
            border: "1px solid rgba(0,255,136,0.2)"
          }, children: "✓" }),
          expanded === mod.id ? /* @__PURE__ */ jsx(ChevronDown, { size: 16, style: {
            color: "var(--text-muted)"
      ...
      expanded === mod.id && /* @__PURE__ */ jsxs("div", { className: "border-t px-5 pb-5", style: {
        borderColor: `${mod.color}10`
      }, children: [
        /* @__PURE__ */ jsx("div", { className: "flex gap-2 mt-4 mb-5 overflow-x-auto pb-1", children: mod.content.map((section, i) => /* @__PURE__ */ jsx("button", { onClick: () => setActiveContent((prev) => ({
          ...prev,
          [`${mod.id}-tab`]: i
        })), className: "px-3 py-1.5 rounded-lg text-xs font-medium whitespace-nowrap transition-all", style: {
        ...
        (() => {
          ...
          return /* @__PURE__ */ jsxs("div", { className: "fade-in-up", children: [
            /* @__PURE__ */ jsx("h4", { className: "text-sm font-semibold mb-3", style: {
              color: mod.color
            }, children: section.heading }),
            /* @__PURE__ */ jsx("p", { className: "text-sm leading-relaxed whitespace-pre-line", style: {
              color: "var(--text-muted)"
            }, children: section.text })
          ] });
        })(),
        /* @__PURE__ */ jsx(DiagramBar, { items: mod.diagram, color: mod.color })
      ] })
    ] }, mod.id)) }),
    /* @__PURE__ */ jsxs("div", { className: "mt-12 glass-card p-6", children: [
      /* @__PURE__ */ jsx("h2", { className: "font-semibold mb-4", style: {
        color: "var(--text-primary)"
      ...
      /* @__PURE__ */ jsx("div", { className: "grid sm:grid-cols-2 gap-3", children: [{
        ...
        title: "Papers With Code — ML Papers",
        url: "#",
        tag: "Research"
      }, {
        ...
        url: "#",
        tag: "Docs"
      }].map((r) => /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-3 rounded-lg text-sm", style: {
        ...
        /* @__PURE__ */ jsx("span", { className: "text-xs px-2 py-0.5 rounded ml-2 flex-shrink-0", style: {
          color: "var(--neon-cyan)",
          background: "rgba(0,245,255,0.08)"
        }, children: r.tag })
      ] }, r.title)) })

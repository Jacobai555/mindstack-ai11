import {
  ...
  BaseVideoAdapter
} from "./chunk-XY7V2F4D.js";
import "./chunk-QB6SBWHX.js";
import "./chunk-G3PMV62Z.js";

// node_modules/@tanstack/ai-openai/dist/esm/text/text-provider-options.js
...
// node_modules/@tanstack/ai-openai/dist/esm/utils/schema-converter.js
...
// node_modules/@tanstack/ai-openai/dist/esm/tools/apply-patch-tool.js
...
// node_modules/@tanstack/ai-openai/dist/esm/tools/code-interpreter-tool.js
...
// node_modules/@tanstack/ai-openai/dist/esm/tools/computer-use-tool.js
...
// node_modules/@tanstack/ai-openai/dist/esm/tools/custom-tool.js
...
// node_modules/@tanstack/ai-openai/dist/esm/tools/file-search-tool.js
...
// node_modules/@tanstack/ai-openai/dist/esm/tools/function-tool.js
function convertFunctionToolToAdapterFormat(tool) {
  ...
  return {
    ...
    strict: true
    // Always use strict mode since our schema converter handles the requirements
  };
}

// node_modules/@tanstack/ai-openai/dist/esm/tools/image-generation-tool.js
...
// node_modules/@tanstack/ai-openai/dist/esm/tools/local-shell-tool.js
...
// node_modules/@tanstack/ai-openai/dist/esm/tools/mcp-tool.js
...
function convertMCPToolToAdapterFormat(tool) {
  ...
  validateMCPtool(mcpTool2);
  return mcpTool2;
}

// node_modules/@tanstack/ai-openai/dist/esm/tools/shell-tool.js
...
// node_modules/@tanstack/ai-openai/dist/esm/tools/web-search-preview-tool.js
...
// node_modules/@tanstack/ai-openai/dist/esm/tools/web-search-tool.js
function convertWebSearchToolToAdapterFormat(tool) {
  const metadata = tool.metadata;
  return metadata;
}

// node_modules/@tanstack/ai-openai/dist/esm/tools/tool-converter.js
...
// node_modules/@tanstack/ai-openai/dist/esm/utils/client.js
...
// node_modules/@tanstack/ai-openai/dist/esm/adapters/text.js
var OpenAITextAdapter = class extends BaseTextAdapter {
...
// node_modules/@tanstack/ai-openai/dist/esm/adapters/summarize.js
var OpenAISummarizeAdapter = class extends BaseSummarizeAdapter {
  constructor(config, model) {
    super({}, model);
    this.kind = "summarize";
    this.name = "openai";
...
// node_modules/@tanstack/ai-openai/dist/esm/image/image-provider-options.js
...
function validateNumberOfImages(model, numberOfImages) {
  ...
  if (model === "dall-e-3" && numberOfImages !== 1) {
    throw new Error(
      `Model "dall-e-3" only supports generating 1 image at a time. Requested: ${numberOfImages}`
    );
  }
...
var validatePrompt = (options) => {
  ...
  if ((options.model === "gpt-image-1" || options.model === "gpt-image-1-mini") && options.prompt.length > 32e3) {
    throw new Error(
      "For gpt-image-1/gpt-image-1-mini, prompt length must be less than or equal to 32000 characters."
    );
  }
  if (options.model === "dall-e-2" && options.prompt.length > 1e3) {
    throw new Error(
      "For dall-e-2, prompt length must be less than or equal to 1000 characters."
    );
  }
  if (options.model === "dall-e-3" && options.prompt.length > 4e3) {
    throw new Error(
...
// node_modules/@tanstack/ai-openai/dist/esm/adapters/image.js
...
// node_modules/@tanstack/ai-openai/dist/esm/video/video-provider-options.js
...
function validateVideoSeconds(model, seconds) {
  ...
  const validNumbers = [4, 8, 12];
  if (seconds !== void 0) {
    const isValid = typeof seconds === "string" ? validSeconds.includes(seconds) : validNumbers.includes(seconds);
    if (!isValid) {
      throw new Error(
...
// node_modules/@tanstack/ai-openai/dist/esm/adapters/video.js
...
// node_modules/@tanstack/ai-openai/dist/esm/audio/audio-provider-options.js
...
// node_modules/@tanstack/ai-openai/dist/esm/adapters/tts.js
...
// node_modules/@tanstack/ai-openai/dist/esm/adapters/transcription.js
...
// node_modules/@tanstack/ai-openai/dist/esm/model-meta.js
var GPT5_2 = {
  name: "gpt-5.2"
};
var GPT5_2_PRO = {
...
// node_modules/@tanstack/ai-openai/dist/esm/realtime/token.js
var OPENAI_REALTIME_SESSIONS_URL = "https://api.openai.com/v1/realtime/sessions";
...
// node_modules/@tanstack/ai-openai/dist/esm/realtime/adapter.js
...
async function createWebRTCConnection(token) {
  ...
  const connection = {
    ...
    sendImage(imageData, mimeType) {
      ...
      const imageContent = isUrl ? { type: "input_image", image_url: imageData } : {
        type: "input_image",
    ...
    updateSession(config) {
      ...
      if (config.maxOutputTokens !== void 0) {
...
//# sourceMappingURL=@tanstack_ai-openai.js.map

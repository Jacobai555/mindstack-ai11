import { OpenAIBaseOptions, OpenAIMetadataOptions, OpenAIReasoningOptions, OpenAIReasoningOptionsWithConcise, OpenAIStreamingOptions, OpenAIStructuredOutputOptions, OpenAIToolsOptions } from './text/text-provider-options.js';
...
declare const GPT5_2_PRO: {
    ...
    readonly supports: {
        ...
        readonly tools: ["web_search", "file_search", "image_generation", "mcp"];
    };
    readonly pricing: {
        readonly input: {
            readonly normal: 21;
...
declare const GPT5_MINI: {
    ...
    readonly supports: {
        ...
        readonly tools: ["web_search", "file_search", "mcp", "code_interpreter"];
    };
    readonly pricing: {
        readonly input: {
...
declare const GPT5_NANO: {
    ...
    readonly supports: {
        ...
        readonly endpoints: ["chat", "chat-completions", "batch"];
        readonly features: ["streaming", "structured_outputs", "function_calling"];
        readonly tools: ["web_search", "file_search", "mcp", "image_generation", "code_interpreter"];
    };
};
...
export declare const OPENAI_CHAT_MODELS: readonly ["gpt-5.2", "gpt-5.2-pro", "gpt-5.2-chat-latest", "gpt-5.1", "gpt-5.1-codex", "gpt-5", "gpt-5-mini", "gpt-5-nano", "gpt-5-pro", "gpt-5-codex", "o3", "o3-pro", "o3-mini", "o4-mini", "o3-deep-research", "o4-mini-deep-research", "gpt-4.1", "gpt-4.1-mini", "gpt-4.1-nano", "gpt-4", "gpt-4-turbo", "gpt-4o", "gpt-4o-mini", "gpt-3.5-turbo", "gpt-audio", "gpt-audio-mini", "gpt-4o-audio", "gpt-4o-mini-audio", "gpt-5.1-chat-latest", "gpt-5-chat-latest", "chatgpt-4o-latest", "gpt-5.1-codex-mini", "codex-mini-latest", "gpt-4o-search-preview", "gpt-4o-mini-search-preview", "computer-use-preview", "o1", "o1-pro", "gpt-5.4-mini", "gpt-5.4-nano"];
export type OpenAIChatModel = (typeof OPENAI_CHAT_MODELS)[number];
export declare const OPENAI_IMAGE_MODELS: readonly ["gpt-image-1", "gpt-image-1-mini", "dall-e-3", "dall-e-2"];
...
export type OpenAIChatModelProviderOptionsByName = {
    [GPT5_2.name]: OpenAIBaseOptions & OpenAIReasoningOptions & OpenAIStructuredOutputOptions & OpenAIToolsOptions & OpenAIStreamingOptions & OpenAIMetadataOptions;
    ...
    [GPT5_2_PRO.name]: OpenAIBaseOptions & OpenAIReasoningOptions & OpenAIToolsOptions & OpenAIStreamingOptions & OpenAIMetadataOptions;
    [GPT5_1.name]: OpenAIBaseOptions & OpenAIReasoningOptions & OpenAIStructuredOutputOptions & OpenAIToolsOptions & OpenAIStreamingOptions & OpenAIMetadataOptions;
    [GPT5_1_CODEX.name]: OpenAIBaseOptions & OpenAIReasoningOptions & OpenAIStructuredOutputOptions & OpenAIToolsOptions & OpenAIStreamingOptions & OpenAIMetadataOptions;
    [GPT5.name]: OpenAIBaseOptions & OpenAIReasoningOptions & OpenAIStructuredOutputOptions & OpenAIToolsOptions & OpenAIStreamingOptions & OpenAIMetadataOptions;
    ...
    [GPT5_PRO.name]: OpenAIBaseOptions & OpenAIReasoningOptions & OpenAIStructuredOutputOptions & OpenAIToolsOptions & OpenAIStreamingOptions & OpenAIMetadataOptions;
    ...
    [O3_DEEP_RESEARCH.name]: OpenAIBaseOptions & OpenAIReasoningOptions & OpenAIMetadataOptions;
    [O4_MINI_DEEP_RESEARCH.name]: OpenAIBaseOptions & OpenAIReasoningOptions & OpenAIMetadataOptions;
    ...
    [GPT_5_1_CHAT.name]: OpenAIBaseOptions & OpenAIReasoningOptions & OpenAIStructuredOutputOptions & OpenAIMetadataOptions;
    [GPT_5_CHAT.name]: OpenAIBaseOptions & OpenAIReasoningOptions & OpenAIStructuredOutputOptions & OpenAIMetadataOptions;
    ...
    [COMPUTER_USE_PREVIEW.name]: OpenAIBaseOptions & OpenAIReasoningOptionsWithConcise & OpenAIToolsOptions & OpenAIStreamingOptions & OpenAIMetadataOptions;

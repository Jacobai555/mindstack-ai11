...
declare class AiEventClient extends EventClient<AIDevtoolsEventMap> {
    constructor();
}
declare const aiEventClient: AiEventClient;
export { aiEventClient };
export { devtoolsMiddleware, type DevtoolsChatMiddleware, } from './devtools-middleware.js';

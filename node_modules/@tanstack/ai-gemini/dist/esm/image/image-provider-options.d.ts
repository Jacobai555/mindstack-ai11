 ...
 */
export type GeminiAspectRatio = '1:1' | '3:4' | '4:3' | '9:16' | '16:9' | '9:21' | '21:9';
/**
 ...
 */
export declare const GEMINI_SIZE_TO_ASPECT_RATIO: Record<string, GeminiAspectRatio>;
/**
 * Maps a WIDTHxHEIGHT size string to a Gemini aspect ratio
 * Returns undefined if the size cannot be mapped
 */
export declare function sizeToAspectRatio(size: string | undefined): GeminiAspectRatio | undefined;
/**
 ...
 */
export declare function validatePrompt(options: {
    prompt: string;
    model: string;
}): void;
/**

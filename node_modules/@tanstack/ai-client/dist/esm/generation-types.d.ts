...
export declare const GENERATION_EVENTS: {
    ...
    readonly VIDEO_JOB_CREATED: "video:job:created";
    /** Video job status update */
    readonly VIDEO_STATUS: "video:status";
};
/**
 ...
 */
export type GenerationFetcher<TInput, TResult> = (input: TInput, options?: GenerationFetcherOptions) => Promise<TResult | Response>;
/**

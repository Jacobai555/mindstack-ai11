...
export interface SubscribeConnectionAdapter {
     ...
     */
    send: (messages: Array<UIMessage> | Array<ModelMessage>, data?: Record<string, any>, abortSignal?: AbortSignal) => Promise<void>;
}
/**
 * Connection adapter union.
 * Provide either `connect`, or `subscribe` + `send`.
 */
export type ConnectionAdapter = ConnectConnectionAdapter | SubscribeConnectionAdapter;
/**
 ...
 */
export declare function normalizeConnectionAdapter(connection: ConnectionAdapter | undefined): SubscribeConnectionAdapter;
/**
 ...
 * ```
 */
export declare function stream(streamFactory: (messages: Array<UIMessage> | Array<ModelMessage>, data?: Record<string, any>) => AsyncIterable<StreamChunk>): ConnectConnectionAdapter;
/**
 ...
 * ```
 */
export declare function rpcStream(rpcCall: (messages: Array<UIMessage> | Array<ModelMessage>, data?: Record<string, any>) => AsyncIterable<StreamChunk>): ConnectConnectionAdapter;
